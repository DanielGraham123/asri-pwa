        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <DashLink href="/dashboard">
            <a className="flex items-center gap-3">
              ...
              {sidebarExpanded && (
                <span className="text-3xl font-medium text-white -mb-2">
                  A.S.R.I.
                </span>
              )}
            </a>
                ...
                <DashLink href="/dashboard">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 text-sla duration-200">
                        Campaign
                      </span>
                    </div>
                  </a>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <DashLink href="/dashboard">
                              <a className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 text-sla duration-200">
                                  Team - Tabs
                                </span>
                              </a>
                            </DashLink>
