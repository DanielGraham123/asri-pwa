...
function DashboardCard01() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-blue-800 shadow-lg text-gray-200 rounded-sm border border-slate-200">
      <div className="px-5 pt-5">
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold mr-2">2,480</div>
