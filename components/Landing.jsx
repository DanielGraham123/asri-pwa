...
function Landing() {
  return (
    <div className="bg-white">
      <header className="">
        <Popover className="fixed z-10 w-full bg-[#0F172A]">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            <div className="flex justify-start items-center lg:w-0 lg:flex-1">
              ...
              <h1 className="ml-3 text-3xl text-indigo-100 font-bold">
                A.S.R.I.
              </h1>
            </div>
            <div className="-mr-2 -my-2 md:hidden">
              <Popover.Button className="bg-[#0F172A] rounded-md p-2 inline-flex items-center justify-center text-gray-200 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        open ? "text-indigo-500" : "text-gray-200",
                        "group bg-transparent rounded-md inline-flex items-center text-base font-medium hover:text-indigo-500 focus:outline-none focus:ring-0 focus:ring-offset-0"
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
                    ...
                    >
                      <Popover.Panel className="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                          <div className="relative grid gap-6 bg-[#0F172A] px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                            {solutions.map((item) => (
                              <a
                                key={item.name}
                                href={item.href}
                                className="-m-3 p-3 flex items-start rounded-lg hover:shadow-md hover:border-slate-500 hover:border-2"
                              >
                                ...
                                <div className="ml-4">
                                  <p className="text-base font-medium text-indigo-500">
                                    {item.name}
                                  </p>
              ...
              <a
                href="#"
                className="text-base font-medium text-gray-200 hover:text-indigo-500"
              >
                Pricing
              </a>
              <a
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a
                href="/signin"
                className="whitespace-nowrap text-base font-medium text-gray-200 hover:text-indigo-500"
              >
                Sign in
              </a>
              <a
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto ">
            <div className="relative shadow-xl sm:overflow-hidden">
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-gray-500 to-gray-500 mix-blend-multiply" />
              </div>
              <div className="relative px-4 mt-12   sm:px-6 sm:py-36 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">Automatic System</span>
                  <span className="block text-indigo-300">
                    For Recognition & Identification
                  </span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                  Saving lifes with top AI and facial recognition software. Elit
        ...
        <div className="relative ">
          <div className="lg:mx-auto  bg-gradient-to-r from-purple-800 to-indigo-700 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
            <div className="relative my-24">
              ...
              <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                ...
                <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-indigo-600 via-ingido-600 opacity-90" />
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                <h2 className="text-3xl text-indigo-200 font-bold tracking-tight sm:text-4xl">
                  On a mission to empower teams
                </h2>
                <div className="mt-6 text-indigo-300 space-y-6">
                  <p className="text-lg">
              ...
              <div className="mt-10">
                <dl className="grid grid-cols-2 gap-x-4 gap-y-8">
                  {stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="border-t-2 border-indigo-100 pt-6"
                    >
                      <dt className="text-base font-medium text-indigo-300">
                        {stat.label}
                      </dt>
                      <dd className="text-3xl font-extrabold tracking-tight text-indigo-200">
                        {stat.value}
                      </dd>
                    </div>
                  ))}
        ...
        {/* CTA section */}
        <div className="relative mt-12 sm:mt-12 sm:py-16 ">
          <div aria-hidden="true" className="hidden sm:block">
            <div className="absolute inset-y-0 left-0 w-1/2 bg-indigo-100 rounded-r-3xl" />
            <svg
          ...
          <div className="mx-auto max-w-md  px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="relative rounded-2xl px-6 py-10 bg-blue-800 overflow-hidden shadow-xl sm:px-12 sm:py-20">
              <div
                aria-hidden="true"
      ...
      <footer className="mt-24 bg-gray-900 sm:mt-12">
        <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; 2022 A.S.R.I., Powered by{" "}
            <a
              href="https://mettrix.net/"
              target="_blank"
              className="font-bold"
            >
              Mettrix
